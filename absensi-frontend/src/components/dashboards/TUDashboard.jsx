  ...
  return (
    <div className="space-y-8">
      <div className="bg-white border border-gray-200 p-8 rounded-lg text-center">
        <h2 className="text-xl font-bold text-[#183057] mb-2">Pusat Administrasi Tata Usaha</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <button onClick={() => navigate('/students')} className="p-6 bg-gray-50 border border-gray-200 rounded-md hover:bg-[#183057] hover:text-white transition-colors group">
          ...
          <button onClick={() => navigate('/teachers')} className="p-6 bg-gray-50 border border-gray-200 rounded-md hover:bg-[#183057] hover:text-white transition-colors group">
          ...
          <button onClick={() => navigate('/classes')} className="p-6 bg-gray-50 border border-gray-200 rounded-md hover:bg-[#183057] hover:text-white transition-colors group">
